# Generated by Django 5.0.8 on 2024-08-27 20:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(('small_pos_int__in', [0, 2, 32767]), ('small_pos_int__isnull', True), _connector='OR'), name='tests_db_default_DBDefaultTester_small_pos_int_SmallPosIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='dbdefaulttester',
            constraint=models.CheckConstraint(check=models.Q(('small_int__in', [-32768, 0, 1, 2, 32767])), name='tests_db_default_DBDefaultTester_small_int_SmallIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='dbdefaulttester',
            constraint=models.CheckConstraint(check=models.Q(('pos_int__in', [0, 1, 2, 2147483647])), name='tests_db_default_DBDefaultTester_pos_int_PosIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='dbdefaulttester',
            constraint=models.CheckConstraint(check=models.Q(('int__in', [-2147483648, 0, 1, 2, 2147483647]), ('int__isnull', True), _connector='OR'), name='tests_db_default_DBDefaultTester_int_IntEnum'),
        ),
        migrations.AddConstraint(
            model_name='dbdefaulttester',
        ...
        migrations.AddConstraint(
            model_name='dbdefaulttester',
            constraint=models.CheckConstraint(check=models.Q(('big_int__in', [-2147483649, 1, 2, 2147483648])), name='tests_db_default_DBDefaultTester_big_int_BigIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='dbdefaulttester',
            constraint=models.CheckConstraint(check=models.Q(('constant__in', [3.141592653589793, 2.71828, 1.618033988749895]), ('constant__isnull', True), _connector='OR'), name='tests_db_default_DBDefaultTester_constant_Constants'),
        ),
        migrations.AddConstraint(
            model_name='dbdefaulttester',
        ...
        migrations.AddConstraint(
            model_name='dbdefaulttester',
            constraint=models.CheckConstraint(check=models.Q(('extern__in', [1, 2, 3]), ('extern__isnull', True), _connector='OR'), name='tests_db_default_DBDefaultTester_extern_ExternEnum'),
        ),
        migrations.AddConstraint(
            model_name='dbdefaulttester',
        ...
        migrations.AddConstraint(
            model_name='dbdefaulttester',
            constraint=models.CheckConstraint(check=models.Q(('dj_text_enum__in', ['A', 'B', 'C'])), name='tests_db_default_DBDefaultTester_dj_text_enum_DJTextEnum'),
        ),
        migrations.AddConstraint(
            model_name='dbdefaulttester',
        ...
        migrations.AddConstraint(
            model_name='dbdefaulttester',
            constraint=models.CheckConstraint(check=models.Q(('no_coerce_value__in', [0, 2, 32767]), ('no_coerce_value__isnull', True), _connector='OR'), name='tests_db_default_DBDefaultTester_no_coerce_value_SmallPosIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='dbdefaulttester',
            constraint=models.CheckConstraint(check=models.Q(('no_coerce_none__in', [0, 2, 32767]), ('no_coerce_none__isnull', True), _connector='OR'), name='tests_db_default_DBDefaultTester_no_coerce_none_SmallPosIntEnum'),
        ),
    ]
