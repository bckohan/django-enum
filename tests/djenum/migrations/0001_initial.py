    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('str_props', django_enum.fields.EnumCharField(choices=[(tests.djenum.enums.StrProps('str1'), 'STR1'), (tests.djenum.enums.StrProps('str2'), 'STR2'), (tests.djenum.enums.StrProps('str3'), 'STR3')], max_length=4)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(('multi__in', ['1', '2.0', '3.0', '4.5']), ('multi__isnull', True), _connector='OR'), name='tests_djenum_MultiPrimitiveTestModel_multi_MultiPrimitiveEnum'),
        ),
        migrations.AddConstraint(
            model_name='multiprimitivetestmodel',
        ...
        migrations.AddConstraint(
            model_name='multiprimitivetestmodel',
            constraint=models.CheckConstraint(check=models.Q(('multi_none__in', [None, '1', '2.0', '3.0', '4.5']), ('multi_none__isnull', True), _connector='OR'), name='tests_djenum_MultiPrimitiveTestModel_multi_none_MultiWithNone'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('small_pos_int__in', [0, 2, 32767]), ('small_pos_int__isnull', True), _connector='OR'), name='tests_djenum_EnumTester_small_pos_int_SmallPosIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('small_int__in', [-32768, 0, 1, 2, 32767])), name='tests_djenum_EnumTester_small_int_SmallIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('pos_int__in', [0, 1, 2, 2147483647])), name='tests_djenum_EnumTester_pos_int_PosIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('int__in', [-2147483648, 0, 1, 2, 2147483647]), ('int__isnull', True), _connector='OR'), name='tests_djenum_EnumTester_int_IntEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('big_pos_int__in', [0, 1, 2, 2147483648]), ('big_pos_int__isnull', True), _connector='OR'), name='tests_djenum_EnumTester_big_pos_int_BigPosIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('big_int__in', [-2147483649, 1, 2, 2147483648])), name='tests_djenum_EnumTester_big_int_BigIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('constant__in', [3.141592653589793, 2.71828, 1.618033988749895]), ('constant__isnull', True), _connector='OR'), name='tests_djenum_EnumTester_constant_Constants'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('text__in', ['V1', 'V22', 'V333', 'D']), ('text__isnull', True), _connector='OR'), name='tests_djenum_EnumTester_text_TextEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('extern__in', [1, 2, 3]), ('extern__isnull', True), _connector='OR'), name='tests_djenum_EnumTester_extern_ExternEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('dj_int_enum__in', [1, 2, 3])), name='tests_djenum_EnumTester_dj_int_enum_DJIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('dj_text_enum__in', ['A', 'B', 'C'])), name='tests_djenum_EnumTester_dj_text_enum_DJTextEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('no_coerce__in', [0, 2, 32767]), ('no_coerce__isnull', True), _connector='OR'), name='tests_djenum_EnumTester_no_coerce_SmallPosIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('date_enum__in', [datetime.date(1984, 8, 7), datetime.date(1989, 7, 27), datetime.date(2016, 9, 9)])), name='tests_djenum_EnumTester_date_enum_DateEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('time_enum__in', [datetime.time(17, 0), datetime.time(12, 30), datetime.time(9, 0)]), ('time_enum__isnull', True), _connector='OR'), name='tests_djenum_EnumTester_time_enum_TimeEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('duration_enum__in', [datetime.timedelta(days=1), datetime.timedelta(days=7), datetime.timedelta(days=14)]), ('duration_enum__isnull', True), _connector='OR'), name='tests_djenum_EnumTester_duration_enum_DurationEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('decimal_enum__in', [Decimal('0.99'), Decimal('0.999'), Decimal('0.9999'), Decimal('99.9999'), Decimal('999')])), name='tests_djenum_EnumTester_decimal_enum_DecimalEnum'),
        ),
        migrations.AddField(
            model_name='enumflagtesterrelated',
            name='related_flags',
            field=models.ManyToManyField(related_name='related_flags', to='tests_djenum.enumflagtester'),
        ),
        migrations.AddConstraint(
            model_name='emptyenumvaluetester',
            constraint=models.CheckConstraint(check=models.Q(('blank_text_enum__in', ['', 'V22'])), name='tests_djenum_EmptyEnumValueTester_blank_text_enum_BlankTextEnum'),
        ),
        migrations.AddConstraint(
            model_name='emptyenumvaluetester',
            constraint=models.CheckConstraint(check=models.Q(('none_int_enum__in', [None, 2]), ('none_int_enum__isnull', True), _connector='OR'), name='tests_djenum_EmptyEnumValueTester_none_int_enum_NoneIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='emptyenumvaluetester',
        ...
        migrations.AddConstraint(
            model_name='customprimitivetestmodel',
            constraint=models.CheckConstraint(check=models.Q(('str_props__in', ['str1', 'str2', 'str3'])), name='tests_djenum_CustomPrimitiveTestModel_str_props_StrPropsEnum'),
        ),
        migrations.AddConstraint(
            model_name='baddefault',
            constraint=models.CheckConstraint(check=models.Q(('non_strict_int__in', [0, 2, 32767]), ('non_strict_int__isnull', True), _connector='OR'), name='tests_djenum_BadDefault_non_strict_int_SmallPosIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='admindisplaybug35',
            constraint=models.CheckConstraint(check=models.Q(('text_enum__in', ['V1', 'V22', 'V333', 'D'])), name='tests_djenum_AdminDisplayBug35_text_enum_TextEnum'),
        ),
        migrations.AddConstraint(
            model_name='admindisplaybug35',
            constraint=models.CheckConstraint(check=models.Q(('int_enum__in', [0, 2, 32767])), name='tests_djenum_AdminDisplayBug35_int_enum_SmallPosIntEnum'),
        ),
        migrations.AddConstraint(
            model_name='admindisplaybug35',
        ...
        migrations.AddConstraint(
            model_name='admindisplaybug35',
            constraint=models.CheckConstraint(check=models.Q(('blank_txt__in', ['V1', 'V22', 'V333', 'D']), ('blank_txt__isnull', True), _connector='OR'), name='tests_djenum_AdminDisplayBug35_blank_txt_TextEnum'),
        ),
    ]
