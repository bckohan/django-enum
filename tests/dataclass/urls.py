...
from tests.dataclass.views import (
...
try:
    ...
    from tests.dataclass.views import DRFView
...
try:
    ...
    from tests.dataclass.views import EnumTesterFilterViewSet
