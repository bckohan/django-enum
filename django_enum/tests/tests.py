...
if ENUM_PROPERTIES_INSTALLED:
    ...
    class PerformanceTest(TestCase):
        ...
        def create(self, obj=None):
            ...
            if (obj is None and self.create_queue) or len(self.create_queue) >= self.CHUNK_SIZE:
                self.create_queue[0].__class__.objects.bulk_create(self.create_queue)
        ...
        def test_single_field_benchmark(self):
            ...
            self.assertTrue((enum_time / choice_time) < 1.6)
            self.assertTrue((no_coerce_time / choice_time) < 1.3)
