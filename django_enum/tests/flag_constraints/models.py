...
if sys.version_info >= (3, 11):
    ...
    class FlagConstraintTestModel(models.Model):
        ...
        eject = EnumField(EjectFlagEnum, null=False, default=EjectFlagEnum(0), blank=True)
        eject_non_strict = EnumField(EjectFlagEnum, null=False, default=EjectFlagEnum(0), blank=True, strict=False)
