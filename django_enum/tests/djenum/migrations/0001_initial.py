# Generated by Django 4.2.3 on 2023-07-09 16:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('small_pos', django_enum.fields.FlagPositiveSmallIntegerField(blank=True, choices=[(4096, 'VAL1'), (8192, 'VAL2'), (16384, 'VAL3')], db_index=True, default=0, null=True)),
