...
class DBDefaultTester(models.Model):
    ...
    small_int = EnumField(SmallIntEnum, null=False, db_default=SmallIntEnum.VAL3, blank=True)
    ...
    doubled_char_field = models.CharField(default='default', db_default='db_default', blank=True, max_length=10)
