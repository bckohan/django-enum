# Generated by Django 3.2.18 on 2023-03-29 02:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bit_field_large', django_enum.fields.EnumBitField(blank=True, choices=[(1, 'One'), (340282366920938463463374607431768211456, 'Two')], default=None, null=True)),
                ('bit_field_large_neg', django_enum.fields.EnumBitField(choices=[(-340282366920938463463374607431768211456, 'Negative One'), (0, 'Zero')], default=-340282366920938463463374607431768211456)),
                ('no_default', django_enum.fields.EnumBitField(choices=[(1, 'One'), (340282366920938463463374607431768211456, 'Two')])),
            ],
        ),
        migrations.CreateModel(
            name='EnumTester',
