...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(('small_pos_int__in', [0, 2, 32767])), name='go_enum_tests_enum_prop_enumtester_small_pos_int_smallposintenum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
        ...
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('int__in', [-2147483648, 0, 1, 2, 2147483647])), name='django_enum_tests_enum_prop_enumtester_int_intenum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
        ...
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('text__in', ['V1', 'V22', 'V333', 'D'])), name='django_enum_tests_enum_prop_enumtester_text_textenum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
        ...
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('time_enum__in', [datetime.time(17, 0), datetime.time(12, 30), datetime.time(9, 0)])), name='django_enum_tests_enum_prop_enumtester_time_enum_timeenum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('duration_enum__in', [datetime.timedelta(days=1), datetime.timedelta(days=7), datetime.timedelta(days=14)])), name='jango_enum_tests_enum_prop_enumtester_duration_enum_durationenum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
        ...
        migrations.AddConstraint(
            model_name='enumtester',
            constraint=models.CheckConstraint(check=models.Q(('no_coerce__in', [0, 2, 32767])), name='django_enum_tests_enum_prop_enumtester_no_coerce_smallposintenum'),
        ),
        migrations.AddConstraint(
            model_name='enumtester',
