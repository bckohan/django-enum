...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='enumflagproptester',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('small_pos__gte', 0), ('small_pos__lte', 32767)), ('small_pos__isnull', True), _connector='OR'), name='sts_enum_prop_EnumFlagPropTester_small_pos_SmallPositiveFlagEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumflagproptester',
            constraint=models.CheckConstraint(check=models.Q(('pos__gte', 0), ('pos__lte', 2147483647)), name='ngo_enum_tests_enum_prop_EnumFlagPropTester_pos_PositiveFlagEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumflagproptester',
            constraint=models.CheckConstraint(check=models.Q(('big_pos__gte', 0), ('big_pos__lte', 9223372036854775807)), name='m_tests_enum_prop_EnumFlagPropTester_big_pos_BigPositiveFlagEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumflagproptester',
            constraint=models.CheckConstraint(check=models.Q(('small_neg__gte', -65535), ('small_neg__lte', 0)), name='sts_enum_prop_EnumFlagPropTester_small_neg_SmallNegativeFlagEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumflagproptester',
            constraint=models.CheckConstraint(check=models.Q(('neg__gte', -4294967295), ('neg__lte', 0)), name='ngo_enum_tests_enum_prop_EnumFlagPropTester_neg_NegativeFlagEnum'),
        ),
        migrations.AddConstraint(
            model_name='enumflagproptester',
            constraint=models.CheckConstraint(check=models.Q(('big_neg__gte', -18446744073709551615), ('big_neg__lte', 0)), name='m_tests_enum_prop_EnumFlagPropTester_big_neg_BigNegativeFlagEnum'),
        ),
        migrations.AddConstraint(
