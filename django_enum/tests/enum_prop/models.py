try:
    ...
    class EnumTester(models.Model):
        ...
        constant = EnumField(
            Constants, null=True, default=None, db_index=True, blank=True
        )
        ...
        extern = EnumField(
            ExternEnum, null=True, default=None, db_index=True, blank=True
        )
        ...
        def get_absolute_url(self):
            return reverse(
                "django_enum_tests_enum_prop:enum-detail", kwargs={"pk": self.pk}
            )
