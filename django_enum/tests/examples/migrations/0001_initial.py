...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(('color__in', ['R', 'G', 'B'])), name='django_enum_tests_examples_TextChoicesExample_color_Color'),
        ),
        migrations.AddConstraint(
            model_name='mymodel',
            constraint=models.CheckConstraint(check=models.Q(('txt_enum__in', ['V0', 'V1', 'V2']), ('txt_enum__isnull', True), _connector='OR'), name='django_enum_tests_examples_MyModel_txt_enum_TextEnum'),
        ),
        migrations.AddConstraint(
            model_name='mymodel',
            constraint=models.CheckConstraint(check=models.Q(('int_enum__in', [1, 2, 3])), name='django_enum_tests_examples_MyModel_int_enum_IntEnum'),
        ),
        migrations.AddConstraint(
            model_name='map',
            constraint=models.CheckConstraint(check=models.Q(('style__in', [1, 2, 3, 4, 5, 6, 7, 8])), name='django_enum_tests_examples_Map_style_MapBoxStyle'),
        ),
    ]
